...
public class AddRecipeJFrame extends javax.swing.JFrame {
    ...
    public AddRecipeJFrame(JDialog dialog, AccessRecipesJFrame presenter) {
        this();
    ...
    private void initComponents() {
        ...
        addRecipeButton.setText("Done");
        addRecipeButton.setPreferredSize(new java.awt.Dimension(65, 23));
                                ...
                                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(mainPanelLayout.createSequentialGroup()
                                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addGroup(mainPanelLayout.createSequentialGroup()
                                                .addComponent(addRecipeButton, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        addRecipeButton.getAccessibleContext().setAccessibleName("addRecipeButton");
    ...
    private void addRecipeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addRecipeButtonActionPerformed
        ...
        Recipe newRecipe = RecipeManager.addRecipeToDb(recipeName, category, instructionsString, ingredients);
        
        if (newRecipe != null) {
            close();
        } else {
            JOptionPane.showMessageDialog(null, "There was an error adding the recipe!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddRecipeJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddRecipeJFrame().setVisible(true);
            }
        });
    }
